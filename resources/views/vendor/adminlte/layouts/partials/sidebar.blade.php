<aside class="main-sidebar">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="{{ route('home') }}"><i class='fa fa-dashboard text-aqua'></i><span>Inicio</span></a></li>
            ...
            <li><a href="{{ route('envios.index') }}"><i class='fa fa-arrows-h text-aqua'></i> <span>Administrar envios</span></a></li>
